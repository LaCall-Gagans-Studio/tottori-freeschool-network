...
export const metadata: Metadata = {
  ...
  description: "鳥取県内のフリースクール情報を最も詳しくまとめたサイト。不登校や引きこもり、行き渋りのお子さんを抱える方に向けて運営しています。元教員の母と不登校支援の大学生が運営し、フリースクールの特徴やサポート内容を網羅。保護者や学生に役立つ最新情報をお届けします。フリースクールとは、不登校をはじめとして、何らかの課題を抱えるお子さんに「第三の居場所」を提供する民間の施設です。鳥取でおすすめのフリースクールを紹介し、それぞれのフリースクールの特徴や教育方針、価格などをわかりやすく紹介していきます。【とっとりフリースクールネットワーク】は、不登校の子ども、学校を休みがちの子どもについての悩みに寄り添う、保護者や支援者向け不登校ポータルサイトです。｜とっとりフリースクールネットワーク",
  keywords: [
