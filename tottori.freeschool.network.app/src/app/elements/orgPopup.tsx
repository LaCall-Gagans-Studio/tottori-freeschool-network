...
const OrgPopup: React.FC<OrgPopupProps> = ({ onClose }) => {
    ...
    return (
        <>
            <div className={`fixed w-[calc(100vw*5/6)] h-full border-2 top-0 flex items-center right-0 justify-center z-50`}>
                <div
                ...
                >
                        <div className={`relative w-5/6 mx-auto justify-center content-center mt-14 flex flex-col items-center`}>
                            <div className='flex flex-col items-center'>
                                <img src='./common/logo.png' className='w-auto h-36'/>
                                <p className='w-5/6 mt-14'>
                                    『とっとりフリースクールネットワーク』は、鳥取県にある<b>すべてのフリースクールの情報を掲載することを目指して</b>活動しているプロジェクトです。<br />
                                    元教諭の３児の母と、不登校支援に携わる大学生が主に運営しています。<br />
                                    フリースクールの情報をまとめた後は、子ども食堂や養護学校、学童など、<br />
                                    行政と民間が交わる部分である<b>『やわらかいインフラ』</b>の全てを集めることを目指して、活動していきます。<br />
                                </p>
                            </div>
