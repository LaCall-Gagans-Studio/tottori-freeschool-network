    ...
    return (
        <div className="p-4 pt-12 h-[calc(100svh*11/12)] lg:h-full w-full mx-auto overflow-y-scroll">
            <div className="w-full lg:max-w-[800px] lg:w-4/6 h-ull mx-auto grid grid-cols-1 gap-4 lg:gap-8 items-center relative">
                ...
                <div className="w-auto h-auto text-ws-black absolute top-6 text-center left-1/2 -translate-x-1/2 z-10">
                    <p>おっと、何もないようです。</p>
                    <p>絞り込みを解除してみてください。</p>
                </div>
                        ...
                        <div className="h-full z-10 bg-[#f8fdee] pr-3 rounded-lg rounded-r-lg flex relative duration-300 group-hover:-translate-x-8 transition-all">
                            ...
                            <div className="ml-4 pr-3 py-2 w-3/4 rounded-r-lg relative overflow-hidden">
                                ...
                                <div className="mt-2 flex flex-col gap-0.5">
                                    ...
                                    <div className="relative mt-2 mb-1 lg:my-0 lg:absolute lg:bottom-2 lg:right-1 text-[0.6rem] lg:text-xs font-thin flex flex-wrap lg:flex-nowrap gap-1 lg:gap-2 lg:font-semibold text-slate-600">
                                        {event.tag.map((tag) => (
