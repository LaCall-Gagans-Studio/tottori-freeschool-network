...
const EventList: React.FC<EventListProps> = ({ events }) => {
    ...
    return (
        <div className="p-4 pt-12 h-[calc(100svh*11/12)] lg:h-full w-full mx-auto overflow-y-scroll bg-ws-transparent lg:bg-transparent z-20">
            <div className="w-full lg:max-w-[800px] lg:w-4/6 h-auto mx-auto grid grid-cols-1 gap-4 lg:gap-8 items-center relative">
